...
<body id="bodyindex">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col">
                <img src="resources/imagenes/sinfondo2.png" alt="Imagen 3" class="img-fluid" id="sinfondo3"> <br>
                <br> <br><br><br>
                <h3><b>T Launcher</b></h3>
            ...
            <div class="col">
                <img src="resources/imagenes/logo1.png" alt="Imagen 4" class="img-fluid" id="sinfondo4"><br> <br>
                <h3><b>Plugins</b></h3>
    ...
    <div class="container mt-5">
        <div class="row">
            <div class="col">
                <h2 class="text-center"> <b>Descarga tu plugin de Minecraft</b></h2>
            </div>
        </div>
    </div>
                    ...
                    <div class="card-group">
                        <div class="card">
                            ...
                            <div class="card-body" id="cartas">
                                ...
                                <p class="card-text lead">Crea tus centros de teletransportacion para que jamás vuelvas
                                    a perderte</p>
                            </div>
                            <div class="card-footer">
                                <a class="btn btn-secondary" href="resources/imagenes/minecraft5.jpg" download>Descargar el
                                    archivo</a>
                            </div>
                        </div>
                        <div class="card">
                            ...
                            <div class="card-footer">
                                <a class="btn btn-secondary" href="resources/imagenes/minecraft5.png" download>Descargar
                                    el archivo</a>
                            </div>
                        </div>
                        <div class="card">
                            ...
                            <div class="card-body" id="cartas">
                                ...
                                <p class="card-text lead">Modo Asalto: Hay un limite de tiempo, y un maximo de kills; tu
                                    decides quien gana</p>
                            </div>
                            <div class="card-footer">
